        ...
        <div class="flex flex-col md:flex-row md:gap-x-8">
            ...
            lg:mb-0 lg:pt-2">
                <div class="flex flex-col lg:flex-row gap-x-4">
                    ...
                    <div>
                        <h4 class="font-body text-xl mb-1 text-accent">Have a question?</h4>
                        <p class="text-paragraph mb-1">I'm here to help you.</p>
                        <p class="text-accent font-normal">Email me at hmsmiraz64729@gmail.com</p>
                    </div>
                ...
                <div class="flex flex-col lg:flex-row gap-x-4">
                    ...
                    <div>
                        <h4 class="font-body text-xl mb-1 text-accent">My current location</h4>
                        <p class="text-paragraph mb-1">Bangladesh</p>
