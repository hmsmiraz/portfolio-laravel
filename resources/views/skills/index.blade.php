        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('skills.create') }}"
                    class="px-4 py-2 bg-teal-500 hover:bg-indigo-700 rounded-lg text-black">
                    New Skill</a>
            </div>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="flex justify-end py-4 px-6">
                                        ...
                                        <form method="POST" action="{{ route('skills.destroy', $skill->id) }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="font-medium text-red-600 dark:text-red-500 hover:underline mr-3"
